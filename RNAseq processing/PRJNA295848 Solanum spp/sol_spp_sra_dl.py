...
It is only used for when single read seq data
For Solanmum spp, there are two species so script needs to be customised for
each one
'''   
import csv, os, shutil

sra_inputs = 'PRJNA295848_runs.txt'
...
index_file = 'sol_penn_transcripts.idx'
# name of cds file input, used by kallisto to produce .idx file
cds_file = 'Spenn-v2-cds-annot.fa.gz'
