...
Specifically for this script, dark period is started first, and there is a
sample at time 0, followed by light period, hence the colour bar code at the
end of the script, shown below, is adjusted, with vmin= 0 (normally its 1) and
colour bar colour is reversed, with cmap='plasma'

    sc = plt.scatter(phase_specific_PC1, phase_specific_PC2, marker=markers[i],
                     c=phase_specific_cseq, vmin=0, vmax=24, cmap='plasma', s=400)
'''

input_file = 'PRJNA295848_sol_penn_combined_PCA.txt'
colourmap_file = 'PRJNA295848_colourbar.csv'
