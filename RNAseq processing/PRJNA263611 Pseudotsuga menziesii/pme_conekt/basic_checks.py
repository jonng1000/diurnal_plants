...
'''
record_dict1 = SeqIO.to_dict(SeqIO.parse("Psme.HQgenes.transcripts.fasta", "fasta"))
keys_cds = [x.split(' ')[0] for x in record_dict1.keys()] # 35 880 genes
cds_set = set(keys_cds)
len(cds_set) #35 880 genes, same as len(keys_cds) => cds file only has unique genes
