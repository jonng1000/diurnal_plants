...
Note: This one is not used anymore for pme as its annotations from the cds file is unclear, use
Mercator for better annotations.
"""
import csv
from Bio import SeqIO

original_file = "Psme.HQgenes.transcripts.fasta"
