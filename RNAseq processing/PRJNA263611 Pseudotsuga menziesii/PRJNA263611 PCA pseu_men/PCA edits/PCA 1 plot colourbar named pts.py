...
input_file = 'PRJNA263611_PCA_m1.txt'
colourmap_file = 'PRJNA263611_colourbar.csv'
...
for sample in pca_df.index:
    plt.annotate(sample, (pca_df.PC1.loc[sample], pca_df.PC2.loc[sample]), fontsize=30)
plt.savefig('PCA_plot_' + file_name + '_pts.png')
plt.close()
