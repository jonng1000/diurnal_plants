"""
This script is based on the pcc.py script which Marekgave me from OneNote. I modified it
so that it can be run in the command line.
"""
...
filename = sys.argv[1]
output = filename.split('.')[0] + '.PCC'
mcl_output = filename.split('.')[0] + '.forMCL'
