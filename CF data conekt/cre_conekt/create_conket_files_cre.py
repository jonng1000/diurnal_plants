...
'''
original_file = "Creinhardtii_281_v5.6.protein_primaryTranscriptOnly.fa"
corrected_file = "cre_aa_conekt.fa"
#original_file = "Creinhardtii_281_v5.6.cds_primaryTranscriptOnly.fa"
...
# this section is deleted as create_name_desc.py was ran instead
'''
###############################################################################
...
# conekt
###############################################################################
pfam_file =  'cre_aa_conekt_edited.fa.tsv'
...
modified_genes = [x.split('.t')[0] for x in CF_genes]
