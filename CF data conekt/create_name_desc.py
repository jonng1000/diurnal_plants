...
df = pd.read_csv('Gmax_508_Wm82.a4.v1.annotation_info.txt', delimiter="\t", index_col=0)
...
# file.
record_dict = SeqIO.to_dict(SeqIO.parse("Gmax_508_Wm82.a4.v1.cds_primaryTranscriptOnly.fa", "fasta"))
