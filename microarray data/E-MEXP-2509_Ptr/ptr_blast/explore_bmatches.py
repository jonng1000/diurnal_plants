...
len(index_set) #44 570 unique probes

# 5 largest e-values are all 0.000003, values typically range from
# e-10 to much lower
df.nlargest(5, 4)
...
# Conclusion
# ~100 000 probes and ~7 000 of them match to >1 gene with e-values tied for
# lowest value
# Discard these ~7 000 matches