...
df = pd.read_csv('Zmays_284_Ensembl-18_2010-01-MaizeSequence.annotation_info.txt', delimiter="\t", index_col=0)
...
# file.
record_dict = SeqIO.to_dict(SeqIO.parse("Zmays_284_Ensembl-18_2010-01-MaizeSequence.cds_primaryTranscriptOnly.fa", "fasta"))
...
with open(gene_desc_file, 'w', newline='') as new_desc:
    ...
    for key in record_dict.keys():
        ...
        # some gene IDs are weird so am using this method
        name = temp.iloc[0]['locusName']
